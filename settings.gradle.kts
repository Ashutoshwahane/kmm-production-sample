...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("compose-image-loader", "io.github.qdsfdhvh:image-loader:1.6.0")
            library("voyager-navigator", "cafe.adriel.voyager:voyager-navigator:1.0.0-rc06")
            library("insetx", "com.moriatsushi.insetsx:insetsx:0.1.0-alpha10")
            ...
            library("xml-serialization", "io.github.pdvrieze.xmlutil:serialization:0.86.1")
